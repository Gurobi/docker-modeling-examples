...
* [11.0.0, latest](https://github.com/Gurobi/docker-modeling-examples/blob/master/11.0.0/Dockerfile)
...
A simple deployment file is provided as a [reference](https://github.com/Gurobi/docker-modeling-examples/blob/master/11.0.0/k8s.yaml).
