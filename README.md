...
* [10.0.3, latest](https://github.com/Gurobi/docker-modeling-examples/blob/master/10.0.3/Dockerfile)
...
A simple deployment file is provided as a [reference](https://github.com/Gurobi/docker-modeling-examples/blob/master/10.0.3/k8s.yaml).
