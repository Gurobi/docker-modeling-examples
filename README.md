...
* [13.0.0beta1](https://github.com/Gurobi/docker-modeling-examples/blob/master/13.0.0/Dockerfile)
* [12.0.3, latest](https://github.com/Gurobi/docker-modeling-examples/blob/master/12.0.3/Dockerfile)
...
A simple deployment file is provided as a [reference](https://github.com/Gurobi/docker-modeling-examples/blob/master/13.0.0/k8s.yaml).
