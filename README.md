...
* [11.0.1, latest](https://github.com/Gurobi/docker-modeling-examples/blob/master/11.0.1/Dockerfile)
...
A simple deployment file is provided as a [reference](https://github.com/Gurobi/docker-modeling-examples/blob/master/11.0.2/k8s.yaml).
