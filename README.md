...
* [12.0.2, latest](https://github.com/Gurobi/docker-modeling-examples/blob/master/12.0.2/Dockerfile)
...
A simple deployment file is provided as a [reference](https://github.com/Gurobi/docker-modeling-examples/blob/master/12.0.2/k8s.yaml).
